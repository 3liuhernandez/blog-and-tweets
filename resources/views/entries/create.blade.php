                ...
                <div class="card-body">
                    ...
                    <form action="{{ url('entries') }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="content" class="form-control @error('content') is-invalid @enderror" name="content" required autocomplete="content" placeholder="Content">{{ old('content') }}</textarea>
